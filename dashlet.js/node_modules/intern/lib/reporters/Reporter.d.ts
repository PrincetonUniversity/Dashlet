...
export declare const eventHandler: () => {
    ...
    <T extends "coverage" | "*" | "afterRun" | "beforeRun" | "deprecated" | "error" | "log" | "runEnd" | "runStart" | "suiteAdd" | "suiteEnd" | "suiteStart" | "testAdd" | "testEnd" | "testStart" | "warning">(target: any, propertyKey: T, _descriptor: TypedPropertyDescriptor<(data: Events[T]) => void | Promise<any>>): void;
};
